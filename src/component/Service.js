      ...
      <div className="contanier">
                <div className="row">
                    <div className="col-10">
                        <form action="">
                            <input className="form-control form-control-lg px-5" type="search " placeholder="Search Anything" aria-label="Search"/><svg className='search' xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none">
